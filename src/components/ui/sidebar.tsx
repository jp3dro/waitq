...
function Sidebar({
  ...
  return (
    <div
      ...
      data-state={state}
      // Treat collapsible="none" as "always expanded" (no collapse styling),
      // while still using the floating/inset desktop layout.
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          collapsible === "none" ? "" : "group-data-[collapsible=offExamples]:w-0",
      ...
      >
        <div
          ...
          className={cn(
            ...
            // Floating variant: glassy / macOS-like
            ...
            "group-data-[variant=floating]:bg-sidebar/65 group-data-[variant=floating]:supports-backdrop-filter:backdrop-blur-xl"
          )}
        >
          {children}
        </div>
...
const sidebarMenuButtonVariants = cva(
  "ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground gap-2 rounded-md p-2 mx-2 text-left text-sm transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 data-active:font-bold peer/menu-button flex items-center overflow-hidden outline-hidden disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
