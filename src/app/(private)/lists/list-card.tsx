    ...
    <div className="relative">
      ...
      <details className="absolute top-2 right-2">
        ...
        <div className="absolute right-0 mt-1 w-40 rounded-md border bg-white shadow-sm text-sm z-10">
          <a href={`/display/${id}`} className="block px-3 py-1.5 hover:bg-neutral-50">Open public display</a>
          <a href={`/lists/${id}`} className="block px-3 py-1.5 hover:bg-neutral-50">Edit</a>
