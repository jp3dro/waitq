...
### ![Self checking in at restaurant](/images/couple.jpg)&#xA;3\. Let guests check themselves in

[Self check-in](https://waitq.app/features/self-check-in) allows guests to add themselves to the waitlist faster and efficiently. This [frees up hosts](https://waitq.app/blog/self-check-in-vs-host-managed-service-restaurants) to focus on greeting and seating rather than taking down names.
